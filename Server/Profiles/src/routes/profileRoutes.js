...
const { createProfile, updateProfile, deleteProfile, getUserProfile, followUser, unfollowUser, getNotifications, getSingleNotification, markNotificationAsRead, markAllNotificationsAsRead, getOwnProfile, getSuggestions, searchUsers } = require("../Controllers/profileController");
...
profileRouter.get("/searchUsers/:searchTerm", searchUsers)
